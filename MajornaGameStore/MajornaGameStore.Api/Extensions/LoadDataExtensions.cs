...
{
    public static IEndpointRouteBuilder MapLoadProductEndPoints(this IEndpointRouteBuilder app)
    {
        var group = app.MapGroup("/loadProducts");

        group.MapGet("/", LoadProducts);
        return app;
    }

    public static async Task<IResult> LoadProducts(IProductRepository productRepo, 
                                                    ITypeRepository typeRepo,
                                                    DeveloperRepository developerRepo,
                                                    PublisherRepository publisherRepo,
                                                    ScreenshotRepository screenshotRepo,
